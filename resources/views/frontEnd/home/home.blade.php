            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="latest-product">
                        <h2 class="section-title pt-4"><b>Latest Products</b></h2>
                        <div class="product-carousel">
                            @foreach($products as $product)
                            <div class="single-product" style="padding-left:22px">
                                <div class="product-f-image">
                                    <img src="{{asset($product->image)}}" alt="" style="width: 280px; height: 290px">
                                    <div class="product-hover">
                                        <a href="" class="add-to-cart-link" style="width:83%"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                ...
                                <h4><a href="{{route('product-details',['id'=>$product->id])}}">{{$product->brand_name}}</a></h4>
                                <div class="product-carousel-price">
                                    <ins>{{$product->price}}Taka</ins> <del>25000.00</del>
                                </div>
                            </div>
                            @endforeach
                        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <div class="single-wid-product">
                            <a href=""><img src="{{asset('frontEndAsset')}}/img/product-thumb-1.jpg" alt="" class="product-thumb"></a>
                        ...
                        <div class="single-wid-product">
                            <a href=""><img src="{{asset('frontEndAsset')}}/img/product-thumb-2.jpg" alt="" class="product-thumb"></a>
                        ...
                        <div class="single-wid-product">
                            <a href=""><img src="{{asset('frontEndAsset')}}/img/product-thumb-3.jpg" alt="" class="product-thumb"></a>
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="#" class="wid-view-more">View All</a>
                        <div class="single-wid-product">
                            <a href=""><img src="{{asset('frontEndAsset')}}/img/product-thumb-4.jpg" alt="" class="product-thumb"></a>
